...
func SetupRoutes(router *gin.Engine) {
	...
	api.Use(middleware.AuthMiddleware())
	{
		...
		api.GET("/operator_features", OperatorDetailView.GetOperatorFeaturesClickHouse)
		api.POST("/operator_features/live", OperatorDetailView.GetOperatorFeaturesLive)
		api.GET("/search_operator_packets", SidReview.SearchOperatorPacketsBySID)
		api.GET("/anamolous_sids", SidReview.GetAnamolousSIDs)
		api.GET("/anomaly_groups", SidReview.GetAnomalyGroups)
		...
		api.GET("/operator_feedback_stats", OperatorDetailView.GetOperatorFeedbackStats)
		...
		api.POST("/profile/feedback_stats", Profile.GetMyFeedbackStats)
