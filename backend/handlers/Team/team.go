...
func UpdateUser(c *gin.Context) {
	...
	// Invalidate the auth cache for this user so the next request sees the
	// updated status/role/group instead of waiting for the TTL to expire.
	auth.InvalidateUserCache(targetADID)
