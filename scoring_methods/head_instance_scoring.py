...
spark_submit_command = f"""
            ...
            --py-files s3a://prd-bi-data-platform-uploads/sparkjobs/operator360/category_risk_scoring_combined/instance_scoring_methods.py \
            s3a://prd-bi-data-platform-uploads/sparkjobs/operator360/category_risk_scoring_combined/instances_main.py {instance_feature_name} {instance_feature_version}
"""
